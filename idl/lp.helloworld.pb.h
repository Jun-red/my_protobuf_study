...
#ifndef PROTOBUF_INCLUDED_lp_2ehelloworld_2eproto
#define PROTOBUF_INCLUDED_lp_2ehelloworld_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_lp_2ehelloworld_2eproto 
...
namespace google {
namespace protobuf {
template<> ::lp::helloworld* Arena::CreateMaybeMessage<::lp::helloworld>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace lp {
...
class helloworld : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:lp.helloworld) */ {
 public:
  helloworld();
  virtual ~helloworld();
  ...
  // @@protoc_insertion_point(class_scope:lp.helloworld)
 private:
  ...
  friend struct ::protobuf_lp_2ehelloworld_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::int32 helloworld::id() const {
  // @@protoc_insertion_point(field_get:lp.helloworld.id)
  return id_;
}
inline void helloworld::set_id(::google::protobuf::int32 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:lp.helloworld.id)
}
...
inline const ::std::string& helloworld::str() const {
  // @@protoc_insertion_point(field_get:lp.helloworld.str)
  return str_.GetNoArena();
}
inline void helloworld::set_str(const ::std::string& value) {
  
  str_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:lp.helloworld.str)
}
#if LANG_CXX11
inline void helloworld::set_str(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:lp.helloworld.str)
}
#endif
inline void helloworld::set_str(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:lp.helloworld.str)
}
inline void helloworld::set_str(const char* value, size_t size) {
  
  str_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:lp.helloworld.str)
}
inline ::std::string* helloworld::mutable_str() {
  
  // @@protoc_insertion_point(field_mutable:lp.helloworld.str)
  return str_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* helloworld::release_str() {
  // @@protoc_insertion_point(field_release:lp.helloworld.str)
...
inline void helloworld::set_allocated_str(::std::string* str) {
  ...
  // @@protoc_insertion_point(field_set_allocated:lp.helloworld.str)
}
...
inline ::google::protobuf::int32 helloworld::opt() const {
  // @@protoc_insertion_point(field_get:lp.helloworld.opt)
  return opt_;
}
inline void helloworld::set_opt(::google::protobuf::int32 value) {
  
  opt_ = value;
  // @@protoc_insertion_point(field_set:lp.helloworld.opt)
}
...
#endif  // PROTOBUF_INCLUDED_lp_2ehelloworld_2eproto
